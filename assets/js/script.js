...
$(document).ready(function () {
  $(".new-radius-btn").click(function () {
    // Encontra o botão de rádio dentro da div clicada
    var radioBtn = $(this).find('input[type="radio"]');

    // Se o botão de rádio clicado não está marcado, atualiza a seleção
    if (!radioBtn.prop("checked")) {
      // Remove a classe dos botões de rádio anteriores
      $(".new-radius-btn").removeClass("new-radius-btn-selected");

      // Adiciona a classe ao botão de rádio clicado
      $(this).addClass("new-radius-btn-selected");
